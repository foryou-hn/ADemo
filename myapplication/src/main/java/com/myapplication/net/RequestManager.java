...
public class RequestManager {
    ...
    private static final String BASE_URL = "http://route.showapi.com/";//请求接口根地址
    ...
    private <T> void successCallBack(final T result, final ReqCallBack<T> callBack) {
        okHttpHandler.post(new Runnable() {
            ...
            public void run() {
                if (callBack != null) {
                    try {
                        ResultItem resultItem = new ResultItem(new JSONObject((String) result));
                        callBack.onReqSuccess(resultItem);
